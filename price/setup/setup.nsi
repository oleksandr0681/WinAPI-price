...
;Задает текст, который будет выведен деинсталлятором для 
;подтверждения удаления вашего продукта.
...
LicenseData "d:\Shurik\Program\Turbo_Cpp_10_0\project\WinAPI\price\help\license.txt"
